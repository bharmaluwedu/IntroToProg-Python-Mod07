...
# Change Log: Mohammad Ammar Bharmal, 3/10/2024,Created Script (2nd Attempt)
...
class Student(Person):
    def __init__(self, first_name: str, last_name: str, course: str, gpa: float = 0.0):
...
class FileProcessor:
    ...
    ChangeLog: Mohammad Ammar Bharmal, 3/10/2024,Created Class (2nd Attempt)
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: Mohammad Ammar Bharmal, 3/10/2024,Created function (2nd Attempt)
...
class IO:
    ...
    def output_student_and_course_names(student_data: list):
        ...
        for student in student_data:
            print(f'Student {student["FirstName"]} '
                  f'{student["LastName"]} is enrolled in {student["CourseName"]} and GPA of {student["GPA"]}')
        print("-" * 50)
    ...
    def input_student_data(student_data: list):
        ...
        try:
            ...
            gpa = input("Please enter the GPA of student: ")
            ...
            print()
            print(f"You have registered {student_first_name} {student_last_name} for {course_name} and GPA of {gpa}.")
